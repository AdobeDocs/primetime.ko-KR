...
## PTAI 2.2.2의 개선 사항 및 수정 사항

이 릴리스는 광고 크리에이티브 호출, 광고 서버 호출 및 사용 가능한 해결 이벤트와 같은 새로운 광고 성능 이벤트를 캡처하는 데 중점을 둡니다. 이러한 이벤트는 향후 릴리스에서 Primetime Ad Insertion의 새로운 그래픽 사용자 인터페이스를 통해 노출됩니다.
