...
* Xcode10을 준수하기 위해 TVSDK가 &quot;`libstdc++`&quot;에서 &quot;`libc++`&quot;로 이동했으며, 따라서 iOS 7에서 지원되는 최소 버전이 제공되고 있습니다. 이전에는 iOS 6이었습니다.
...
VPAID 2.0에 대한 자세한 내용은 VPAID [광고 지원을 참조하십시오](../programming/tvsdk-1.4-for-ios/ad-insertion/c-psdk-ios-1.4-vpaid-2.0-ads.md).
...
자세한 내용은 VAST 및 [VMAP 광고에 대한 광고 폴백을 참조하십시오](../programming/tvsdk-1.4-for-ios/ad-insertion/c-psdk-ios-1.4-ad-fallback.md).
...
자세한 내용은 청구 지표 [를 참조하십시오](../programming/tvsdk-1.4-for-ios/c-psdk-ios-1.4-billing/c-psdk-ios-1.4-billing.md).
...
이 문제는 AssetDuration API를 추가하여 라이브/선형 스트림의 자산 지속 시간 `PTVideoAnalyticsTrackingMetadata` 을 업데이트하고 라이브 스트림을 확인하는 논리를 제공하여 해결되었습니다.
