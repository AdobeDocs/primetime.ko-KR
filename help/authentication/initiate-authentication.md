...
>
> * generic\_data - [프로모션 TempPass](/help/authentication/promotional-temp-pass.md)
>
>```JSON
>Example:
...
* 의 값 `domain_name` 매개 변수는 Primetime 인증과 함께 등록된 도메인 이름 중 하나로 설정해야 합니다. 자세한 내용은 [등록 및 초기화](/help/authentication/programmer-overview.md).

* [/authenticate 요청에서 &#39;&amp;&#39;reg\_code를 사용하지 마십시오(기술 참고)](/help/authentication/clientless-avoid-using-reg-code-in-authenticate-request.md)
