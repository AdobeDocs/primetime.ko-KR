...
<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> RUNTIME_CODE 메타데이터 키의 값 </th> 
   <th colname="col2" class="entry"> RUNTIME_CODE_MESSAGE 메타데이터 키의 값 </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 미디어 판독기가 <span class="codeph"> setHoldAt</span> API에서 설정한 시간에 도달했으므로 추가로 읽을 수 없습니다. </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> 미디어 판독기가 라이브 창의 끝에 도달하여 세그먼트를 로드할 수 없습니다. 서버가 새 미디어를 라이브 창에 추가하면 세그먼트 로드가 다시 시작됩니다. 이 상태는 일반적으로 다음과 같은 경우에 도달합니다. 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">다음 기간은 보류 중인 미디어 교체(<span class="codeph"> InsertBy</span> API 호출로 인해)가 있는 라이브 기간입니다. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Flash Player에서 HLS 재생이 활성화되지 않았습니다. <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>을 참조하십시오. </td> 
  </tr> 
  <tr> 
