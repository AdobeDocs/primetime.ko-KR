...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> N/A(자동 CustomRange 시그널링 모드) </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <span class="codeph"> 사용자 정의 범위 </span> 신호 모드 </td> 
   <td> 
    <code>
      placement&nbsp;=&nbsp; 
     &nbsp;&nbsp;new&nbsp;Placement( 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <span class="codeph"> 서버 맵 </span> 신호 모드 </td> 
   <td> 없음(광고가 비활성화됨). </td> 
   <td> 
    <code>
      placement&nbsp;=&nbsp; 
   ...
   <td> 해당 사항 없음(자동) <span class="codeph"> 사용자 정의 범위 </span> 시그널링 모드) </td> 
  </tr> 
  <tr> 
   <td> <span class="codeph"> ManifestCue </span> 신호 모드 </td> 
   <td> 없음(광고가 비활성화됨). </td> 
  ...
  <tr> 
   ...
   <td> 없음(광고가 비활성화됨). </td> 
   <td> 없음 </td> 
   <td> 없음(에서 처리됨) <span class="codeph"> CustomRangeOpportunityGenerator </span>) </td> 
  </tr> 
 </tbody> 
</table>
