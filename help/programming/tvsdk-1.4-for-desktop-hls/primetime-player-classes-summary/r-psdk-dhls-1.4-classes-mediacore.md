---
description: Primetime Player API를 사용하여 플레이어의 동작을 사용자 지정할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.
seo-description: Primetime Player API를 사용하여 플레이어의 동작을 사용자 지정할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.
...
Primetime Player API를 사용하여 플레이어의 동작을 사용자 지정할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.

TVSDK에 대한 전체 API 설명서를 보려면 Adobe Primetime API [참조로](https://help.adobe.com/en_US/primetime/api/index.html)이동하십시오.
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 자막의 텍스트에 대한 모든 스타일 속성을 정의하는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"> DefaultAdPolicySelector <a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/DefaultAdPolicySelector.html" format="html" scope="external"></a></span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">MediaPlayerClient <span class="codeph"> 팩터리의 기본 구현으로</span> 메타데이터 및 광고 해결 프로세스를 모두 지원합니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 미디어 플레이어에 대한 추가 컨텍스트를 제공하는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">미디어 플레이어 리소스를 로드하고 해당 MediaPlayerItem <span class="codeph"> 객체를 만드는</span> 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">비디오 렌더링에 MediaPlayer가 사용할 보기 <span class="codeph"> 클래스입니다</span> . </td> 
  </tr> 
  <tr rowsep="1"> 
