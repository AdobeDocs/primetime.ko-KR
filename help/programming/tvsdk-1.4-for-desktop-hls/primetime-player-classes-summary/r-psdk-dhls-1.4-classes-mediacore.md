---
description: Primetime Player API를 사용하여 플레이어의 동작을 사용자 정의할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.
seo-description: Primetime Player API를 사용하여 플레이어의 동작을 사용자 정의할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.
...
Primetime Player API를 사용하여 플레이어의 동작을 사용자 정의할 수 있습니다. 이러한 클래스는 미디어 플레이어 및 해당 리소스에 대해 설명합니다.

TVSDK에 대한 전체 API 설명서를 보려면 [Adobe Primetime API 참조](https://help.adobe.com/en_US/primetime/api/index.html)로 이동하십시오.
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 닫힌 캡션의 텍스트에 대한 모든 스타일 속성을 정의하는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 자막을 표시할지 여부를 제어하는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 광고 워크플로우에 사용되는 다양한 구성 요소를 만들고 관리하기 위한 출하 시 기본 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 광고 재생 비헤이비어에 대한 기본 구현. 애플리케이션에서 광고 행동을 사용자 정의할 수 있는 인터페이스 </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">메타데이터와 광고 해결 프로세스를 모두 지원하는 <span class="codeph"> MediaPlayerClient</span> 팩터리의 기본 구현입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 기본 미디어 플레이어 항목 로더. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"><span class="codeph"> DefaultMediaPlayer</span> 클래스에 대한 공용 인터페이스입니다. 이벤트, PlayerState 및 가시성에 대한 열거형을 포함합니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">미디어 플레이어 리소스를 로드하고 해당 <span class="codeph"> MediaPlayerItem</span> 개체를 만드는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 미디어 플레이어의 지원되는 상태가 포함된 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">비디오 렌더링을 위해 <span class="codeph"> MediaPlayer</span>에서 사용할 뷰의 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 지원되는 미디어 리소스 유형이 포함된 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 기본 큐 태그 외에도 광고 배치를 수행할 때 미디어 플레이어에서 사용하는 사용자 지정 태그를 캡슐화하는 클래스입니다. 또한 애플리케이션에 알림을 받으려는 태그 이름도 포함됩니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 텍스트 스타일을 설명하는 다양한 속성(예: 자막 스타일)을 캡슐화하는 인터페이스입니다. </td> 
  </tr> 
  <tr rowsep="0"> 
