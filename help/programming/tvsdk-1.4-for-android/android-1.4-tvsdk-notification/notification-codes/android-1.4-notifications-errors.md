...
<table frame="all" colsep="1" rowsep="1" id="table_8B61210A406A45ACBE37FC29729DDE22"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> 재생 타임라인에 리소스를 가져오는 동안 오류가 발생했습니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="4"><span class="codeph"> 설명</span> </td> 
   <td colname="5"> 잘못된 광고 메타데이터 형식으로 인해 광고 확인이 실패했습니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> 광고 단계 해결에 실패했습니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> <p>낮은 수준의 AVE 라이브러리에서 오류가 발생했습니다. </p> <p>이러한 메타데이터 키 값에 대한 자세한 내용은 <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> NATIVE_ERROR 알림</a>에 대한 세부 정보를 참조하십시오. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="0"> 
   ...
   <td colname="3"> 없음 </td> 
   <td colname="4"> 없음 </td> 
   <td colname="5"> 일반 오류 이벤트를 표시합니다. 실제로 TVSDK에서 발행되지 않은 경우 TVSDK 오류 이벤트에 해당하는 숫자 코드 범위 끝에 대한 표시자만 있습니다. </td> 
  </tr> 
 </tbody> 
</table>
