...
<table frame="all" colsep="1" rowsep="1" id="table_8B61210A406A45ACBE37FC29729DDE22"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> 없음 </td> 
   <td colname="4"><span class="codeph"> 설명 </span> </td> 
   <td colname="5"> 콘텐트 기간에 대한 정보를 검색하는 동안 오류가 발생했습니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> 없음 </td> 
   <td colname="4"> <span class="codeph"> NATIVE_ERROR_CODE </span> <span class="codeph"> NATIVE_ERROR_NAME </span> 설명 <span class="codeph"></span> <span class="codeph"> 설명</span> <p><b>DRM 세부 정보:</b> </p> <span class="codeph"> DRM_ERROR_STRING</span> NATIVE <span class="codeph"> _SUBERROR_CODE</span> </td> 
   <td colname="5"> <p>하위 수준 AVE 라이브러리에서 오류가 발생했습니다. </p> <p>이러한 <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> 메타데이터 키 값에 대한 자세한 내용은 NATIVE_ERROR 알림에</a> 대한 세부 정보를 참조하십시오. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> 없음 </td> 
   <td colname="4"><span class="codeph"> 설명</span> </td> 
   <td colname="5"> AVE 라이브러리에 뷰를 연결하는 동안 오류가 발생했습니다. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="0"> 
   ...
   <td colname="3"> 없음 </td> 
   <td colname="4"> 없음 </td> 
   <td colname="5"> 일반 오류 이벤트를 표시합니다. 실제로 TVSDK에서 발행되지 않습니다. 이것은 TVSDK 오류 이벤트에 해당하는 숫자 코드 범위 끝의 표식일 뿐입니다. </td> 
  </tr> 
 </tbody> 
</table>
