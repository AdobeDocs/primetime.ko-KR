...
<table frame="all" colsep="1" rowsep="1" id="table_C24772DF203B4DB2ACE6B475698C4C58"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> <p>하위 수준 AVE 라이브러리에서 오류가 발생했습니다. </p> <p>이러한 <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> 메타데이터 필드의 값에 대한 자세한 내용은 NATIVE_ERROR 알림에</a> 대한 세부 정보를 참조하십시오. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="4"><b>DRM</b> <p><span class="codeph"> NATIVE_SUBERROR_CODE</span> DRM <span class="codeph"> _ERROR_STRING</span> </p> </td> 
   <td colname="5"> DRM 보조 오류 코드와 DRM 서버 오류 문자열. 이러한 <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> 메타데이터 필드의 값에 대한 자세한 내용은 NATIVE_ERROR 알림에</a> 대한 세부 정보를 참조하십시오.</td> 
  </tr> 
  <tr rowsep="1"> 
