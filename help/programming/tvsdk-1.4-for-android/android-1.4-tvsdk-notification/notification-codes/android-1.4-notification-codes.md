...
<table frame="all" colsep="1" rowsep="1" id="table_DBA8CACF02DB4AF2B053E560850B49CE"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">알림 유형입니다. 플랫폼에 따라 이 속성은 가능한 값이 <span class="codeph"> INFO</span>, <span class="codeph"> WARN</span> 또는 <span class="codeph"> ERROR</span>인 열거형 유형을 참조합니다. 알림을 위한 최상위 그룹입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
