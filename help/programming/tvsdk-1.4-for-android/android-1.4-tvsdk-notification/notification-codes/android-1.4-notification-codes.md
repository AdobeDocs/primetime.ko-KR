...
<table frame="all" colsep="1" rowsep="1" id="table_DBA8CACF02DB4AF2B053E560850B49CE"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">알림 유형입니다. 플랫폼에 따라 이 속성은 INFO, WARN 또는 ERROR의 가능한 값이 <span class="codeph"> 있는</span>열거형 <span class="codeph"></span>유형을 <span class="codeph"> 참조합니다</span>. 알림을 위한 최상위 수준의 그룹화입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
