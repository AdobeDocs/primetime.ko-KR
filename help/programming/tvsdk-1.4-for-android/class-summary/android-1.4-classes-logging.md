...
<table frame="all" colsep="1" rowsep="1" id="table_389797D3CEF14EA2862E0B20C6E6CC41"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2" rowsep="0"> 클래스. 시작 로그를 정의하고 로그 메시지에 대한 정보를 저장합니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 인터페이스. 사용자 지정 로깅을 활성화합니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">인터페이스. 에 대한 사용자 지정 로거를 구현하는 데 필요한 메서드 <code>primetime-sdk-name</code> 구문. </td> 
  </tr> 
 </tbody>
</table>
