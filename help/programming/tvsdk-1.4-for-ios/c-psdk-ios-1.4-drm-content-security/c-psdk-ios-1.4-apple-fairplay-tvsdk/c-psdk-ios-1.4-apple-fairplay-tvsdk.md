...
1. 구현하여 FairPlay 고객 리소스 로더를 `PTAVAssetResourceLoaderDelegate`만듭니다.
   ...
   자세한 내용은 TVSDK [애플리케이션의](../../../tvsdk-1.4-for-ios/c-psdk-ios-1.4-drm-content-security/c-psdk-ios-1.4-apple-fairplay-tvsdk/c-psdk-ios-1.4-apple-fairplay-tvsdk.md)Apple FairPlay를 참조하십시오.
