...
<table frame="all" colsep="1" rowsep="1" id="table_389797D3CEF14EA2862E0B20C6E6CC41"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2" rowsep="0"> 항목 로그를 정의하고 로그 메시지에 대한 정보를 보유하는 클래스입니다. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 사용자 지정 로깅을 활성화하는 클래스입니다.</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 프로토콜. TVSDK에 대한 사용자 지정 로거를 구현하는 데 필요한 메서드입니다. </td> 
  </tr> 
 </tbody> 
</table>
