...
Adobe은 이 배열을 미리 구성하지만 Adobe 활성 담당자와 함께 작업하여 배열을 변경하고 Adobe 활성 담당자와 함께 작업할 수 있습니다.

TVSDK가 Adobe으로 보내는 통계를 모니터링하려면 Adobe 활성 담당자의 URL을 입수하고 Charles와 같은 네트워크 캡처 도구를 사용하여 데이터를 확인합니다.
