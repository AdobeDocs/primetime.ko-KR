...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">자세한 내용은 <a href="../../tvsdk-2.7-for-android/content-playback-options/ui-configure/t-psdk-android-2.7-ui-seek-scrub-bar-display.md" format="dita" scope="local"> 현재 재생 위치에 검색 스크럽 막대 표시...를 참조하십시오.</a> </td> 
  </tr> 
 </tbody> 
</table>