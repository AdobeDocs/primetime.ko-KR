...
1. DVR을 지원하는 컨트롤 막대를 구현하려면 [현재 재생 위치로 검색 스크러빙 막대 표시...의 단계를 따릅니다.](../../../tvsdk-2.7-for-android/content-playback-options/ui-configure/t-psdk-android-2.7-ui-seek-scrub-bar-display.md)과(와) 다음 차이가 있습니다.
