...
## 플레이어 {#section_9FC936B983CD40439E6D7675197B226C} 구성
...
* **videoBehavior** `ptp.videoPlayer` API를 사용하면  `ptp.videoBehavior`기본 비디오 플레이어를 구성할 수 있는 이 변수를 반환합니다. 일부 재생 관련 설정을 구성해야 하는 경우 이 옵션을 사용할 수 있습니다.
