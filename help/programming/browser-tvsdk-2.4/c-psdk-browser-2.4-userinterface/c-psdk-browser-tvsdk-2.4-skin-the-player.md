...
<table id="table_AC5745DF725543ADBBCD68BA6130DF12"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1">기본 동작은 <span class="codeph"> videoBehavior</span>입니다. </td> 
   <td colname="col2"> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>사진(PIP)</b> </p> </td> 
   <td colname="col2"> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"> .ptp-pip-video-div</span> </td> 
   <td colname="col2"> <p>PIP 비디오가 재생되는 div의 스타일입니다. </p> </td> 
  </tr> 
  <tr> 
...
## {#section_06EE608FC54A4CF5B5DF9DC743CFC740} 되감기
...
<table id="table_F166BD1E8B934B34AF3690BBBAD894B7">
 ...
 <tbody>
  <tr>
   ...
   <td colname="col2"> <p>컨트롤 막대의 [빨리 감기] 단추입니다. </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_22FC521D786B45EB84F230894FFECE79">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1">기본 동작은 <span class="codeph"> audioTrackButtonBehavior</span>입니다. </td>
   <td colname="col2"> </td>
</tr>
  <tr>
  ...
  <tr>
   <td colname="col1">기본 동작은 <span class="codeph"> audioTrackSelectionPanelBehavior</span>입니다. </td>
   <td colname="col2"> </td>
</tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p><span class="codeph"> ptp-audio-track-selection-panel</span>의 머리글입니다. </p> </td>
  </tr>
  <tr>
...
## {#section_B2ADC76E76304A68AD648A00A12B676E} 공유
...
<table id="table_3264C472809D462B8FC16680B96B1AC9">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p><span class="codeph"> ptp-share-video-panel</span>을 열 컨트롤 막대의 소셜 미디어 공유 단추입니다. </p> </td>
  </tr>
  <tr>
   <td colname="col1">기본 동작은 <span class="codeph"> shareVideoButtonBehavior</span>입니다. </td>
   <td colname="col2"> </td>
  </tr>
  <tr>
  ...
  <tr>
   <td colname="col1">기본 동작은 <span class="codeph"> shareVideoPanelBehavior</span>입니다. </td>
   <td colname="col2"> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p><span class="codeph"> share-video-panel-menu</span>의 메뉴 항목입니다. </p> </td>
  </tr>
  <tr>
...
<table id="table_777C7034C9424F8C841DABD480FFAC47">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>닫힌 캡션 패널의 메뉴 항목입니다. </p> </td>
  </tr>
  <tr>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>닫힌 캡션의 옵션 메뉴 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>닫힌 캡션 <span class="uicontrol"> 옵션</span> 메뉴 항목. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>닫힌 캡션 옵션 바닥글. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>닫힌 캡션 옵션 패널의 바닥글에 있는 <span class="uicontrol"> 적용</span> 단추. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">기본 동작은 <span class="codeph"> closedCaptionOptionsPanelBehavior</span>입니다. </td> 
   <td colname="col2"> </td>
  </tr> 
 </tbody> 
</table>
...
<table id="table_EC6EF88E2EDE4B8EBB1C14F87A6161FA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="uicontrol"> 추가 옵션</span> 단추. </p> </td> 
  </tr> 
  <tr> 
...
[!UICONTROL PIP<] 단추의 스타일은 다음과 같습니다.
...
<table id="table_F1ADAC0A4B4E48669828690BDEB4BC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>트릭 비율 표시 구성 요소가 컨트롤 막대에 표시됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
기본 동작은 `thumbnailPreviewBehavior`입니다.
...
<table id="table_E77EDC7D227348E79C7E73FB5D46F992"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>다중 보기에서 컨트롤의 상태입니다. </p> <p>다음 항목에 적용됩니다. 
