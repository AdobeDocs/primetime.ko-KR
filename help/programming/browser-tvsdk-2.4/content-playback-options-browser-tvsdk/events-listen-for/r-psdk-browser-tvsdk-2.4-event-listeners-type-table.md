---
description: Browser TVSDK에 이벤트 리스너를 등록할 때 수신할 이벤트 유형과 콜백 이름을 지정합니다. 이벤트가 발생하면 브라우저 TVSDK가 콜백을 호출하고 적절한 유형의 이벤트 객체에 전달합니다.
seo-description: Browser TVSDK에 이벤트 리스너를 등록할 때 수신할 이벤트 유형과 콜백 이름을 지정합니다. 이벤트가 발생하면 브라우저 TVSDK가 콜백을 호출하고 적절한 유형의 이벤트 객체에 전달합니다.
...
# 콜백을 위한 이벤트 유형 및 클래스{#event-types-and-classes-for-callbacks}

Browser TVSDK에 이벤트 리스너를 등록할 때 수신할 이벤트 유형과 콜백 이름을 지정합니다. 이벤트가 발생하면 브라우저 TVSDK가 콜백을 호출하고 적절한 유형의 이벤트 객체에 전달합니다.
  ...
  <tr rowsep="1"> 
   <td colname="2"> 
    <ul id="ul_jpq_pc4_2y"> 
     ...
     <li id="li_6155ADAF5E964C458E92AFFB4F7D6347"><span class="codeph"> AD_BREAK_SWITCHED</span> </li> 
    </ul> </td> 
