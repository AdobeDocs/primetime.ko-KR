...
seo-description: 브라우저 TVSDK는 비디오 애플리케이션에 기능을 추가하기 위해 구현할 수 있는 다양한 DASH 기능을 지원합니다.
seo-title: 지원되는 DASH 기능
title: 지원되는 DASH 기능
    ...
    <ul id="ul_irb_p2g_xx"> 
     <li id="li_C4643F2978BC4C8ABDB3E6C72C75A468">Widevine on 
      <ul id="ul_7047EA49AA3F40FE8F90E0ED6C028D83"> 
       ...
       <li id="li_BC06B0A6EAAC4FC991C713775A8BB4DA">크로메캐스트 </li> 
      </ul> </li> 
     <li id="li_D48B51C2208F423CB85D08886C2E1C66">Windows 8.1 및 Edge에서 Internet Explorer에서 재생 </li> 
