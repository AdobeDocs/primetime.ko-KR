...
* TVSDK에서 지원하는 기능 목록은 을 참조하십시오. [Primetime 플레이어 TVSDK 기능](../../ios-3x-introduction/ios-3x-overview/ios-3x-overview-of-the-player.md).
* TVSDK 사용을 위한 특정 하드웨어 및 소프트웨어 요구 사항에 대해서는 다음을 참조하십시오. [요구 사항](../../ios-3x-introduction/ios-3x-requirements.md).

이 안내서에서는 Objective-C에서 구현된 iOS용 TVSDK를 사용하여 비디오 플레이어 애플리케이션을 개발하는 방법에 대한 정보를 제공합니다.
...
TVSDK 사용을 위한 특정 하드웨어 및 소프트웨어 요구 사항에 대해서는 요구 사항 을 참조하십시오.
