...
Adobe Primetime에 대한 Android 및 iOS 프로그래밍 도움말입니다. 왼쪽 탐색에 나열된 문서를 사용하면 Android 장치에서 Java를 사용하는 응용 프로그램과 비디오 플레이어를 개발하는 방법과 iOS 장치에서 Objective-C를 사용하는 방법을 배울 수 있습니다.

[현재 출시된 버전에](tvsdk-3x-ios-prog/ios-3x-introduction/ios-3x-overview/ios-3x-overview.md)대한 자세한 내용을 살펴보십시오.
