...
# 사용자가 캡션 트랙을 변경할 수 있음 {#allow-users-to-change-the-caption-track}
...
1. 사용 가능한 자막 트랙 목록을 문자열 배열로 변환합니다.

   활동이 있는 자막 트랙, 즉 TVSDK가 데이터를 발견한 채널은 그에 따라 표시됩니다.
...
1. 사용자가 버튼을 클릭하면 모든 기본 자막 트랙을 나열하는 대화 상자가 표시됩니다.
