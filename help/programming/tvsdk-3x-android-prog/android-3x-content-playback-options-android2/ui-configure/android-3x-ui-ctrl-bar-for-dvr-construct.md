...
1. DVR을 지원하는 컨트롤 막대를 구현하려면 [현재 재생 위치로 검색 스크럽 막대 표시에 있는 단계를 따릅니다.](../../../tvsdk-3x-android-prog/android-3x-content-playback-options-android2/ui-configure/android-3x-ui-seek-scrub-bar-display.md) 를 사용하여 다음을 수행할 수 있습니다.
