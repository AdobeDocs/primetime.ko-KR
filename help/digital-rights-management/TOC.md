...
+ 인증서 등록 안내서 {#certificate-enrollment-guide}
   ...
   + 인증서 요청 {#request-certs}
      ...
      + [도메인 CA 인증서 얻기](certificate-enrollment-guide/request-certs/obtain-domain-ca-certs.md)
   + 인증서 배포 {#deploy-certs}
...
+ Adobe Primetime DRM SDK 5.3.1 {#drm-sdk-5-3-1}
   ...
   + 콘텐츠 배포 워크플로우 {#content-distribution-workflow}
      + [컨텐츠 준비](drm-sdk-overview/content-distribution-workflow/content-preparation.md)
      + [컨텐츠 확보](drm-sdk-overview/content-distribution-workflow/content-acquisition.md)
   ...
   + 추가 배포 시나리오 {#additional-deployment-scenarios}
      + [UltraDular 미디어 및 Adobe Primetime DRM](drm-sdk-overview/adobe-access-components/additional-deployment-scenarios/ultra-violet-media-adobe-access.md)
...
+ DRM 빠른 시작 안내서 {#drm-quick-start}
   ...
   + [암호화된 컨텐츠 패키지](quick-start/package-content.md)
   + [Flash Player 설치 및 재생 테스트 컨텐츠](quick-start/install-fp-playback-test.md)
...
+ Adobe Primetime Cloud DRM 빠른 시작 안내서 {#cloud-drm-quickstart}
   ...
   + [Primetime Cloud DRM에서 지원되지 않는 기능](cloud-quick-start/not-supported.md)
   ...
   + 사용자 정의 인증/권한 {#custom-auth-ent}
      + [사용자 정의 인증/권한 부여(선택 사항)](cloud-quick-start/custom-auth-ent/custom-overview.md)
      + [BEES 파섹](cloud-quick-start/custom-auth-ent/overview.md)
   ...
   + [Adobe Primetime 인증(옵션)](cloud-quick-start/primetime-authentication.md)
   + [사용자 정의 DRM 정책 만들기(선택 사항)](cloud-quick-start/creating-custom-drm-policies/creating-custom-drm-policies.md)
   + [클라우드 DRM을 사용하도록 기존 DRM 컨텐츠 업데이트(선택 사항)](cloud-quick-start/update-existing-drm-to-cloud.md)
...
+ 다중 DRM 워크플로우 {#multi-drm-workflows}
   ...
   + Primetime DRM Cloud 빠른 시작 {#quick-start}
      ...
      + [제공 받기(계정 등)](multi-drm-workflows/quick-start/get-provisioned.md)
      + [키, ID 및 인증](multi-drm-workflows/quick-start/keys-ids-and-authenticators.md)
   ...
   + 워크플로우:패키지, 라이선스 및 재생 {#package-license-play}
      ...
      + [Widevine 및 PlayReady를 위한 다중 DRM 워크플로우](multi-drm-workflows/p-l-and-p/widevine-workflow.md)
      + [Bento4로 컨텐츠 패키징](multi-drm-workflows/p-l-and-p/package-for-widevine/package-for-widevine-with-bento.md)
      + [Adobe Offline Packager를 사용하여 컨텐츠 패키징](multi-drm-workflows/p-l-and-p/package-for-widevine/package-for-widevine-with-aop.md)
      ...
      + [Express 토큰](multi-drm-workflows/p-l-and-p/licensing-widevine-client-key-request/licensing-widevine-client-key-expressplay-tokens.md)
   ...
   + 일반 워크플로우 {#generic-workflows}
      + [Primetime Packager / 클라우드 DRM / TVSDK](multi-drm-workflows/p-l-and-p/generic-workflows/plp-1.md)
   ...
   + ExpressPlay 라이선스 토큰 요청/응답 참조 {#license-token-req-resp-ref}
      ...
      + [재생Ready 라이선스 토큰 요청/응답](multi-drm-workflows/license-token-req-resp-ref/playready-license-token-request.md)
...
+ Adobe Primetime DRM 온-프레미스 개인화 서버 가이드 {#individualization-server}
   ...
   + 서버 구성 속성 {#configuration-properties}
      ...
      + [개인화 CA CRL 만들기](on-premises-i15n-server/server-configuration-section/server-properties/create-i15n-ca-crl.md)
...
+ Primetime DRM Server for Protected Streaming 5.3.1 {#server-for-protected-streaming}
   ...
   + 배포 이해 {#understanding-deployment}
      + [안전한 스트리밍을 위한 Adobe Primetime DRM Server 배포](protected-streaming/understanding-deployment/deplying-drm-for-protected-streaming.md)
      ...
      + [안전한 스트리밍을 위한 Adobe Primetime DRM Server 업그레이드](protected-streaming/understanding-deployment/upgrading-the-license-server.md)
...
+ Adobe Primetime DRM SDK를 사용하여 콘텐츠 보호 - 5.3.1 {#using-drm-sdk}
   ...
   + 런타임 및 애플리케이션 제한 {#runtime-application-restrictions}
      + [Primetime DRM 애플리케이션용 화이트 리스트 보호된 콘텐츠 재생...](protecting-content/introduction/usage-rules/runtime-application-restrictions/whitelist-air.md)
      + [Adobe® Flash® Player SWF용 화이트 리스트](protecting-content/introduction/usage-rules/runtime-application-restrictions/whitelist-flash.md)
      + [보호된 콘텐츠에 액세스할 수 없도록 DRM 클라이언트의 블랙 리스트](protecting-content/introduction/usage-rules/runtime-application-restrictions/blacklist-drm-clients.md)
      + [애플리케이션 런타임 블랙 리스트](protecting-content/introduction/usage-rules/runtime-application-restrictions/blacklist-app-runtimes.md)
      ...
      + [Jailbreak 시행(Adobe Primetime DRM 필요)](protecting-content/introduction/usage-rules/runtime-application-restrictions/jailbreak-enforcement.md)
   ...
   + 패키징 옵션 {#packaging-options}
      ...
      + [컨텐츠의 초기 부분](protecting-content/introduction/packaging-options/initial-portion-content-clear.md)
   ...
   + 사전 생성 및 임베드 라이선스 {#pre-generating-and-embedded-licenses}
   ...
   + 라이센스 서버 구현 {#implementing-the-license-server}
      ...
      + 라이선스 요청 처리 {#handling-license-reqs}
         ...
         + [도메인 기반 라이선스 발급](protecting-content/implementing-the-license-server/handling-license-reqs/domian-bound-licenses.md)
         + [iOS 클라이언트에 원격 키 전달을 위한 라이선스 발행(Adobe Primetime 필요)](protecting-content/implementing-the-license-server/handling-license-reqs/issuing-licenses-remote-ios.md)
      ...
      + 라이선스 체인 {#license-chaining}
         + [향상된 라이센스 체인](protecting-content/implementing-the-license-server/license-chaining/gen-enhanced-license-chaining.md)
   ...
   + [비디오 플레이어 제작](protecting-content/creating-video-players.md)
...
+ Adobe Primetime DRM 참조 구현 5.3.1 {#drm-reference-implementation-5-3-1}
   ...
   + 명령줄 도구 구성 및 실행 {#configure-and-run}
      ...
      + [SWF가 아닌 응용 프로그램 화이트리스트](drm-reference-implementations/command-line-tools/configure-command-line-tools/policy-manager/non-swf-whitelisting.md)
      + [SWF 애플리케이션 화이트리스트](drm-reference-implementations/command-line-tools/configure-command-line-tools/policy-manager/swf-whitelisting.md)
   ...
   + 구성 {#configuration}
      ...
      + [라이선스 서버 데이터베이스 설정](drm-reference-implementations/configuration/setting-up-db-jndi.md)
   ...
   + 사용 모델 구현 {#implement-usage-models}
      ...
      + [사용 모델 데모 활성화](drm-reference-implementations/impl-usage-models/enable-usage-model-demo.md)
   ...
   + 기존 배포 업그레이드 {#upgrade-existing-deploys}
      + [기존 배포 개요 업그레이드](drm-reference-implementations/upgrading-existing-deplys/upgrading-existing-deplys.md)
...
+ Adobe Primetime TVSDK-DRM 워크플로우 {#workflow}
   ...
   + [라이센스 획득 프로세스 개요](tvsdk-drm-workflow/content-protection-process-overview.md)
...
+ 외부 키 관리 시스템에서 Adobe Access DRM 사용 {#external-cek}
   + [Adobe Access DRM 외부 CEK 개요](aaxs-drm-xkey-mgmt/aaxs-drm-using-external-cek-overview.md)
   ...
   + [외부 CEK를 사용하여 라이선스 종료 및 패키지](aaxs-drm-xkey-mgmt/aaxs-drm-using-external-cek.md)
+ 안전한 스트리밍을 위한 Adobe Access Server 사용 {#adobe-access-server}
   ...
   + 안전한 스트리밍을 위한 Adobe Access Server 배포 {#deploying-aaxs-protect-stream}
      ...
      + [Adobe Access 자격 증명](aaxs-protected-streaming/deplying-aaxs-protect-stream/aaxs-credentials.md)
   ...
   + 안전한 스트리밍을 위한 Adobe Access Server 업그레이드 {#upgrading-the-license-server}
   ...
   + 안전한 스트리밍 유틸리티를 위한 Adobe Access Server {#aaxs-protected-streaming-utilities}
...
+ Adobe Access 보안 배포 지침 {#adobe-access-secure-deployment-guidelines}
   + 네트워크 토폴로지 소개 {#overview}
      ...
      + [Adobe Access에서 사용하는 네트워크 프로토콜](aaxs-secure-deployment-guidelines/overview/network-topology-nw-protocols.md)
   ...
   + 라이선스 보호 및 발행 {#issuing-licenses}
      ...
      + [Adobe에서 게시한 CRL을 보완하기 위한 CRL 생성](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-gen-crls-to-supplement-adobe.md)
      + [롤백 감지](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-rollback-detection.md)
      + [라이선스 발행 시 시스템 수](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-rollback-detection-machine-count.md)
      + [재생 보호](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-replay-detection.md)
      + [신뢰할 수 있는 컨텐츠 패키저 화이트 리스트 유지](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-maintain-whitelist.md)
      + [인증 토큰 시간 초과](aaxs-secure-deployment-guidelines/issuing-licenses/protect-license-server-timeout-for-authn-tokens.md)
...
+ Adobe Access SDK 개요 {#overview}
   + [Adobe Access SDK 개요](aaxs-sdk-overview/overview.md)
   + [Adobe Access 정보](aaxs-sdk-overview/about-adobe-access.md)
   ...
   + 콘텐츠 배포 워크플로우 {#content-distribution-workflow}
      ...
      + [컨텐츠 확보](aaxs-sdk-overview/content-distribution-workflow/content-acquisition.md)
   + [Adobe Access 구성 요소](aaxs-sdk-overview/adobe-access-components/adobe-access-sdk.md)
   + [Adobe Access 배포](aaxs-sdk-overview/deploying-adobe-access/configure-adobe-access.md)
   + 추가 배포 시나리오 {#additional-scenarios}
      + [Ultra보라 미디어 및 Adobe Access](aaxs-sdk-overview/deploying-adobe-access/additional-deployment-scenarios/ultra-violet-media-adobe-access.md)
      + [Adobe Pass 및 Adobe Access](aaxs-sdk-overview/deploying-adobe-access/additional-deployment-scenarios/adobe-pass-and-adobe-access.md)
+ 컨텐츠 보호를 위해 Adobe Access SDK 사용 {#using-adobe-access-sdk}
   ...
   + 런타임 및 애플리케이션 제한 {#runtime-and-application-restrictions}
      + [보호된 콘텐츠를 재생할 수 있는 Adobe® Primetime 애플리케이션의 목록](aaxs-protecting-content/content-introduction/content-usage-rules/content-runtime-application-restrictions/content-whitelist-air.md)
      + [보호된 내용을 재생할 수 있는 Adobe® Flash® Player SWF의 허용 목록](aaxs-protecting-content/content-introduction/content-usage-rules/content-runtime-application-restrictions/content-whitelist-flash.md)
      + [보호된 컨텐츠에 액세스할 수 없도록 제한된 DRM 클라이언트의 블랙 목록](aaxs-protecting-content/content-introduction/content-usage-rules/content-runtime-application-restrictions/content-blacklist-drm-clients.md)
      + [보호된 콘텐츠에 액세스할 수 없도록 제한된 애플리케이션 런타임의 블랙 리스트](aaxs-protecting-content/content-introduction/content-usage-rules/content-runtime-application-restrictions/content-blacklist-app-runtimes.md)
   ...
   + 패키징 옵션 {#packaging-option}
      ...
      + [컨텐츠의 초기 부분](aaxs-protecting-content/content-introduction/packaging-options/content-initial-portion-content-clear.md)
   ...
   + SDK 설정 {#setting-up-the-sdk}
      ...
      + [Adobe Access 자격 증명](aaxs-protecting-content/content-setting-up-the-sdk/content-aaxs-credentials.md)
   ...
   + 사전 생성 및 임베드 라이선스 {#pre-generating-and-embedding-liceses}
   ...
   + Adobe Access 요청 처리 {#processing-adobe-access-requests}
      + [Adobe Access 요청 처리](aaxs-protecting-content/content-implementing-the-license-server/content-processing-aaxs-requests/content-processing-aaxs-requests-overview.md)
      ...
      + [향상된 라이센스 체인](aaxs-protecting-content/content-implementing-the-license-server/content-handling-license-reqs/content-gen-enhanced-license-chaining.md)
      + [도메인 기반 라이선스 발행](aaxs-protecting-content/content-implementing-the-license-server/content-handling-license-reqs/content-domian-bound-licenses.md)
      + [iOS 클라이언트에 원격 키 전달을 위한 라이선스 발행(Adobe Primetime 필요)](aaxs-protecting-content/content-implementing-the-license-server/content-handling-license-reqs/content-issuing-licenses-remote-ios.md)
      ...
      + ID 기반의 라이선스 {#licenses}
         ...
         + [무작위 숫자 생성](aaxs-protecting-content/content-implementing-the-license-server/content-generating-random-nos.md)
...
+ Adobe Access Reference 구현 {#reference-implementation}
   + [개요 - 참조 구현 사용](aaxs-reference-implementations/overview.md)
   + [컨텐츠 패키징 및 취소 목록 생성을 위한 명령줄 툴 ](aaxs-reference-implementations/command-line-tools/aaxs-ref-impl-command-line-overview.md)
   ...
   + Flash Access Manager AIR 애플리케이션 사용 {#flash-access-manager-air-app-usage}
      + Flash Access Manager 구성 요소 {#flash-manager-components}
         ...
         + [Packager Server 빌드](aaxs-reference-implementations/fam-air-app-usage/build-fam-air-app-usage/fam-air-app-usage-bld-pkg-srv.md)
         + [Flash Access Manager AIR 애플리케이션 구축](aaxs-reference-implementations/fam-air-app-usage/build-fam-air-app-usage/fam-air-app-usage-bld-fam-air-app.md)
      + [초기 Flash Access Manager 설정](aaxs-reference-implementations/fam-air-app-usage/initial-fam-setup.md)
      + 환경 설정 {#setting-preferences}
         + [환경 설정 개요](aaxs-reference-implementations/fam-air-app-usage/initial-fam-setup-set-prefs/initial-fam-setup-set-prefs-overview.md)
