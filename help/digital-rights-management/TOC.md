...
+ 인증서 등록 안내서 {#certificate-enrollment-guide}
   ...
   + [키 저장](certificate-enrollment-guide/storing-keys.md)
...
+ 컨텐츠 보호에 Adobe Primetime DRM SDK 사용 - 5.3.1 {#using-drm-sdk}
   ...
   + 라이센스 서버 구현 {#implementing-the-license-server}
      ...
      + [라이선스 반환 요청 처리](protecting-content/implementing-the-license-server/handling-license-return-reqs.md)
...
+ Adobe Primetime DRM 참조 구현 5.3.1 {#drm-reference-implementation-5-3-1}
   ...
   + 구성 {#configuration}
      ...
      + [원격 키 전달 속성(iOS)](drm-reference-implementations/configuration/remote-key-properties.md)
...
+ 컨텐츠 보호를 위해 Adobe 액세스 SDK 사용 {#using-adobe-access-sdk}
   ...
   + Adobe 액세스 요청 처리 중 {#processing-adobe-access-requests}
      ...
      + [라이선스 반환 요청 처리](aaxs-protecting-content/content-implementing-the-license-server/content-handling-license-return-reqs.md)
...
+ Adobe 액세스 참조 구현 {#reference-implementation}
   ...
   + 라이선스 서버 및 감시 폴더 패커{#license-server-and-wfp}
      ...
      + [라이선스 서버 속성 파일](aaxs-reference-implementations/license-server-and-wfp/license-server-properties-file.md)
