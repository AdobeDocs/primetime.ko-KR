...
최종 사용자에게 제공할 애플리케이션 기능에 대한 URL만 표시되도록 외부 방화벽을 구성합니다. 외부 사용자가 외부 방화벽을 통해 다음 표에 나열된 URL에만 액세스할 수 있도록 허용:
...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table-bqs-whz-n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">사용자 인증을 위한 URL. 이 URL은 Adobe Access 클라이언트 API를 사용하여 사용자 인증을 수행하는 경우에만 액세스할 수 있어야 합니다. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-yxs-rdn-44"> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">동기화 요청에 대한 URL입니다. 이 URL은 라이센스의 동기화 요구 사항을 지정하는 경우에만 액세스할 수 있어야 합니다. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-plq-ydn-44"> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">도메인 등록 취소에 대한 URL입니다. 이 URL은 도메인 지원을 구현하는 경우에만 액세스할 수 있어야 합니다. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /flashaccess/headerconversion/v1/*</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">클라이언트가 FMRMS 1.x DRM 메타데이터를 Adobe Access DRM 메타데이터로 변환하는 데 사용하는 URL입니다. </p> <p class="- topic/p ">참고:이 <i class="+ topic/ph hi-d/i ">URL은 SSL(HTTPS)을 사용해야 합니다</i>. </p> </td> 
  </tr> 
  <tr rowsep="0" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /edcws/services/urn:EDCLicenseService/*</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">LiveCycle Rights Management ES 웹 서비스 URL. 이전 버전의 FMRMS를 사용하여 컨텐츠를 게시한 경우 이 URL을 통해 이전 클라이언트가 서버에 연결하여 Adobe Access로 업그레이드하라는 메시지가 표시됩니다. </p> <p class="- topic/p ">참고:이 <i class="+ topic/ph hi-d/i ">URL은 SSL(HTTPS)을 사용해야 합니다</i>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /flashaccess/lreturn/v5</span> </td> 
   <td colname="2" class="- topic/entry "> <p>라이선스 반환용 URL. URL은 라이센스 반환 지원을 구현하는 경우에만 액세스할 수 있어야 합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>
>내부 방화벽은 역방향 프록시를 통해 Adobe Access 라이선스 서버에 연결만 허용하며 위에 나열된 URL에만 연결되도록 허용해야 합니다. 확장성을 개선하기 위해 역방향 프록시와 Adobe Access 간의 연결은 HTTP를 통해 이루어집니다.
